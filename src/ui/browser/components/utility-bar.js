...
export class UtilityBar extends LitElement {
    ...
    constructor() {
        ...
        setTimeout(() =>
            window.addEventListener("resize", this.timeDialogResize.bind(this))
        );
    }
    ...
    setUpTimeDialogClose() {
        window.addEventListener("click", (e) => {
            if (
                event.path[0] !=
                this.shadowRoot.querySelector("#gravity-time-display")
            ) {
        ...
        return html`
            <div>
                ...
                <span
                    ...
                    @click=${this.timeDialogOpen.bind(this)}
                >
